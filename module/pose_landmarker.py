from cv2 import circle, COLOR_BGR2RGB, cvtColor
from mediapipe.python.solutions.pose import Pose

mp_pose = Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5, model_complexity=1, static_image_mode=False)
...
def draw(frame, landmarks):
    ...
    for landmark in landmarks:
        circle(frame, (int(landmark[0] * frame_width), int(landmark[1] * frame_height)), 5, (0, 0, 255), -1)
